...
public class Layout implements ILayout {
    ...
    public void draw(Graphics2D g){
        ...
        g.drawString("Voscal", 90, 35);
        g.drawString("Vonka ", 370, 35);
        g.drawString("Elder", 90, 540);
        g.drawString("Pacman", 370, 540);
        g.drawString("Заавар:", 550,300);
        g.drawString("1.Enter дарж шоогоо хаяна уу.", 550,350);
        g.drawString("2.Хүүн дээрээ дарж хөдөлгөнө үү.", 550,400);
        g.drawString("3.ESC дарж гарна уу.", 550,450);
